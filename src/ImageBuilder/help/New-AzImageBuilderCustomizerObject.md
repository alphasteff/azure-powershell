...
```powershell
New-AzImageBuilderCustomizerObject -WindowsUpdateCustomizer -Filter ("exclude:`$_.Title -like '*Preview*'", "include:`$true") -SearchCriterion "BrowseOnly=0 and IsInstalled=0"  -UpdateLimit 100 -CustomizerName 'WindUpdate'
